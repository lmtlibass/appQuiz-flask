...
class TriviaTestCase(unittest.TestCase):
    ...
    def test_get_questions_with_search_term_and_category(self):
        res = self.client().get('/questions?search=search&category=1')
        data = json.loads(res.data)
    ...
    def test_get_questions_with_invalid_category(self):
        res = self.client().get('/questions?search=search&category=1000')
        data = json.loads(res.data)
